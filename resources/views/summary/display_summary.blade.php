                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="w-2/3 logo">
                            <h3 class="summary-heading text-lg font-bold mb-4">{{ __('Order Summary') }}</h3>
                            ...
                            @endforeach
                                           ...
                                           <div class="w-1/3 bg-gray-100 p-4 rounded-lg shadow logo ">
                                            ...
                                            <form method="POST" action="{{ route('summary.updateCon') }}">
                                                @csrf
                                                <label class="flex items-center">
                                                    <input type="checkbox" name="terms" class="form-checkbox">
                                                    <span class="ml-2">{{ __('I agree to the terms and conditions') }}</span>    
                                                </label>
